...
sed -i "/attiqi_app/d" "$WORK_DIR/system/system/system_ext/etc/selinux/mapping/30.0.cil"
...
sed -i "/ker_app/d" "$WORK_DIR/system/system/system_ext/etc/selinux/mapping/30.0.cil"
